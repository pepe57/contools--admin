...
rem Description:
rem   Script enables the Task Scheduler of a new task creation for everyone.
rem
rem   Based on:
...
call :CMD "%%SystemRoot%%\System32\icacls.exe" "%%SystemRoot%%\System32\Tasks" /remove:d "*S-1-1-0"
