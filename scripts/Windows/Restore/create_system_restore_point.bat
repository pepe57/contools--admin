...
"%SystemRoot%\System32\cscript.exe" //NOLOGO //JOB:CREATE_SYSTEM_RESTORE_POINT "%?~f0%?.wsf"
...
<package>
  <job id="CREATE_SYSTEM_RESTORE_POINT">
    <script language="VBScript">
      Dim Date_ : Date_ = Date()
      Dim RestorePoint : Set RestorePoint = GetObject("winmgmts:\\.\root\default:Systemrestore")
      WScript.Echo "Creating system restore point..."
      RestorePoint.CreateRestorePoint "System Start-up - " & Date_, 0, 100
    </script>
  </job>
</package>
